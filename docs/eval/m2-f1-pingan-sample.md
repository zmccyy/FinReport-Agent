...
> 生成时间：2026-07-21T04:51:26+00:00
> PDF：`data\sample_reports\000001_平安银行_2025年年度报告.pdf`
> Ground truth：`data\benchmark\ground_truth\pingan_2025_sample.json`
> LLM 模式：mock（无 GPU）
...
|---|---|---|---|---|---|---|
| balance_sheet | 1.0000 | 1.0000 | **1.0000** | 5 | 0 | 0 |
| income_statement | 1.0000 | 1.0000 | **1.0000** | 5 | 0 | 0 |
| cash_flow | 1.0000 | 1.0000 | **1.0000** | 3 | 0 | 0 |
